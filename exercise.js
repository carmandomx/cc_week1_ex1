...
const cToF = (c) => {
    ...
    console.log(f); // I console logged the solution, I could also have used the return keyword
    /* Only make changes below this comment */
}
cToF(10); // callback of the function with the temperature in celsius, the output will be in farenheit
